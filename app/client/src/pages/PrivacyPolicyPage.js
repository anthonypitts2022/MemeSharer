...
const PrivacyPolicyPage = () => (
  <div>
    ...
    When you submit content (such as a post or comment or public chat) to the Services, any visitors to and users of our Services will be able to see that content, the username associated with the content, and the date and time you originally submitted the content. MemeSharer allows other websites to embed public MemeSharer content via our embed tools. MemeSharer also allows third parties to access public MemeSharer content via the MemeSharer API and via other similar technologies. Although some parts of the Services may be private or quarantined, they may become public (e.g., at the moderator’s option in the case of private communities) and you should take that into consideration before posting to the Services.
    ...
    When other users view your profile, they will be able to see information about your activities on the Services, such as your username, prior posts and comments, karma, trophies, moderator status, MemeSharer Gold status, and how long you have been a member of the Services. If you choose to make the information public, your profile may also include your voting history.
    ...
    With linked services. If you link your MemeSharer account with a third-party service, MemeSharer will share the information you authorize with that third-party service. You can control this sharing as described in "Your Choices" below.
    ...
    To enforce our policies and rights. We may share information if we believe your actions are inconsistent with our user agreements, rules, or other MemeSharer policies, or to protect the rights, property, and safety of ourselves and others.
    With our affiliates. We may share information between and among MemeSharer, and any of our parents, affiliates, subsidiaries, and other companies under common control and ownership.
    ...
    Our ad partners and ad networks may use cookies and related technologies to collect information when ads are delivered to you on our Services, but MemeSharer does not link to or provide them with your actual MemeSharer account details. This means that MemeSharer does not share your individual account browsing habits with advertisers. MemeSharer cannot see advertisers’ cookies and advertisers will not see MemeSharer cookies.
    ...
    Your Choices
    As a MemeSharer user, you have choices about how to protect and limit the collection, use, and disclosure of information about you.
    ...
    In connection with MemeSharer's processing of personal data received from the European Union and Switzerland, we adhere to the EU-U.S. and Swiss-U.S. Privacy Shield Program (“Privacy Shield”) and comply with its framework and principles.
